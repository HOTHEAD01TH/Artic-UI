...
declare const buttonVariants: (props?: ({
    variant?: "default" | "secondary" | "ghost" | "gradient" | null | undefined;
...
} & framer_motion.MotionProps, "ref"> & React.RefAttributes<HTMLButtonElement>>;
...
declare const Alert: ({ message, variant, className, ...props }: AlertProps) => React.JSX.Element;

export { Alert, type AlertProps, Button, type ButtonProps, alertVariants, buttonVariants, cn };
